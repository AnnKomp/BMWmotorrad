...
<div id="popup-container">
    <div id="popup-content">
        ...
        <h2>Confirmation de la demande d'offre</h2>
...
<div id="form">
    ...
    <H1>Votre demande d'offre a été envoyée avec succès. Le concessionnaire choisi vous contactera sous peu par mail.</H1>
