...
<div id="popup-container">
    <div id="popup-content">
        ...
        <h2>La connexion</h2>
        <br>
        <p>Pour vous connecter, rentrez l'adresse email utilisée pour créer votre compte et le mot de passe puis cliquez sur le bouton "SE CONNECTER".</p>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
                <a id="signup" class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800" href="{{ route('register') }}">
                    {{ __('Inscription') }}
                </a>
